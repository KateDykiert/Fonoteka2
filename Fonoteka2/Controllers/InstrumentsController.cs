...
namespace Fonoteka2.Controllers
{
    public class InstrumentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdInstrumentu,Nazwa,Rodzaj")] Instrument instrument)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdInstrumentu,Nazwa,Rodzaj")] Instrument instrument)
        {
            if (ModelState.IsValid)
            {
